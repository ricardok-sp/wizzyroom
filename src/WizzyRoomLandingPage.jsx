  ...
  <section className="hero-bg bg-purpleLogo text-darkPurpleLogo py-20">
    <div className="container mx-auto px-4 text-center">
      ...
      <div className="flex justify-center space-x-4">
        <a href="#video" className="border-2 border-darkPurpleLogo text-darkPurpleLogo bg-yellowLogo px-6 py-3 rounded-full font-semibold hover:bg-darkPurpleLogo hover:text-yellowLogo transition shadow-none">See How It Works</a>
        <a href="#video" className="border-2 border-darkPurpleLogo text-darkPurpleLogo bg-yellowLogo px-6 py-3 rounded-full font-semibold hover:bg-darkPurpleLogo hover:text-yellowLogo transition shadow-none">Watch the Magic Happen</a>
      </div>
    </div>
  </section>
);
...
const ThemesSection = () => (
  <section className="py-16 bg-yellowLogo/10 themes-bg">
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="theme-card bg-[#FFFBEE] p-6 rounded-lg shadow-md text-center">
  ...
  <section className="py-16 bg-yellowLogo/10">
    <div className="container mx-auto px-4">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-6">
          <h3 className="text-xl md:text-2xl font-bold">Is installation difficult?</h3>
          <p>Not at all. Each kit includes instructions and remote support is available.</p>
        </div>
        <div className="mb-6">
          <h3 className="text-xl md:text-2xl font-bold">Does it require power or Wi-Fi?</h3>
          <p>Only a basic power outlet. No internet required for interaction.</p>
        </div>
        <div className="mb-6">
          <h3 className="text-xl md:text-2xl font-bold">Can I update the theme later?</h3>
          <p>Yes, we offer theme expansion packs you can swap out easily.</p>
        </div>
        <div className="mb-6">
          <h3 className="text-xl md:text-2xl font-bold">Is it safe for kids?</h3>
